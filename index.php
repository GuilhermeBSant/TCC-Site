    ...
    <div class="container">
      <div class="card login-card">
        <div class="row no-gutters">
          <div class="col-md-5">
            <img src="assets/images/login22.jpg" alt="login" class="login-card-img">
          </div>
          <div class="col-md-7">
            <div class="card-body">
              ...
              <form action="recebe.php" method="post">
                  ...
                  <button type="submit" name="login" id="login" class="btn btn-block login-btn mb-4" value="Login">Logar</button> 
                </form>
               <!-- <a href="esqueceuasenha.php" class="forgot-password-link">Esqueceu a senha?</a> -->
                <p class="login-card-footer-text">Não tem uma conta? <a href="cadastro.php" class="text-reset">Cadastre-se aqui</a></p>
